...
$arrayOfWeek = null;
$arrayOfWeek = array(
    'name' => $data['searchSystemSummary'][0]['searchSystem'],
    'count' => null,
    'week' => array()
);
foreach ($data['searchSystemSummary'] as $key => $system) {
//echo $key;
    $count = 0;
    $startString = 2;
    //var_dump($system);
    foreach ($data['searchSystemDetaly'] as $element) {
        //var_dump($element);
...
unset($data['searchSystemSummary']);
unset($data['searchSystemDetaly']);
